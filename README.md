...
[![My Skills](https://skillicons.dev/icons?i=c,cpp,python,php,django,typescript,flask,flutter,docker,firebase,mongodb,mysql,figma,html,css,tailwindcss,bootstrap,linux,kali,git,github,bash,androidstudio)](https://skillicons.dev)
